...
<div class="pa-toast"  v-show="show" v-stop>
	<div class="pa-toast-all">
...
export default{
	...
	computed:{
		ipStyle(){
			return {
				'pa-toast-success':this.type === 'success',
				'pa-toast-warn':this.type === 'warn',
				'pa-toast-cancel':this.type === 'cancel',
				'pa-toast-text':this.type === 'text',
			}
		},
	},
	props:{
		...
		type:{
			type:String,
			validator(value){
		        return ['success', 'warn', 'cancel', 'text'].indexOf(value) !== -1
		     },
		    default:'success'
		},
		time:{
